...
\subsection{Real}
Read and write accesses have been recorded by tracing team for some real world programs, and fast access mode shows an improvement in terms of execution time performances.
...
Figure~\ref{fig:flow-i-d} shows a comparison of execution time for the same various real world programs address tracks, in simple access mode and fast access mode, if instruction and data flows are kept separated. These results can be used to build a possible hybrid hardware and software architecture to maximize performances.
...
%\subsection{Real}
%Real world memory read and write accesses have been recorder by tracing team, and they show the same results.

%\begin{table}[H]
%\center
%\begin{tabular}{| c | c | c | c |}\hline
%test	&	simple	& fast		& speedup \\ \hline
%01	&	873617	& 819560	& 1.07 \\ \hline	% unk
%02	&	1309183	& 655367	& 2.00 \\ \hline	% kate
%03	&	1006501	& 1029926	& 0.98 \\ \hline	% ls
%04	&	998589	& 980791	& 1.02 \\ \hline	% true
%05	& 26256287	& 15204079	& 1.32 \\ \hline	% array
%\end{tabular}
%\caption{Time needed to perform 32768 memory access of various real world test programs}
%\end{table}
