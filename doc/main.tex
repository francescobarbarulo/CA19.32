...
\begin{itemize}
    ...
    \item \texttt{optimizedBehavior(uint16\_t)}: computes memory access times according to the past access history, as described in Section~\ref{sec:fast-page-access};
